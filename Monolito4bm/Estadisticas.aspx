...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        /* Contenedor principal con temática Rosa */
        .dashboard-wrapper {
            background-color: #fdf2f8; /* Fondo muy suave rosa clarito */
            padding: 20px;
            ...
            border-radius: 12px;
            box-shadow: 0 8px 20px rgba(190, 24, 93, 0.15); /* Sombra elegante tono rosa */
        ...
        .report-container {
            ...
            background: white;
            border: 2px solid rgba(244,143,177,0.4); /* Borde Rosa pastel */
            border-radius: 8px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="dashboard-wrapper">
        <h2 class="dashboard-title"><i class="fa-solid fa-chart-line"></i> Panel de Estadísticas</h2>
